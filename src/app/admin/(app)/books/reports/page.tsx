...
export default async function BooksReportsPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-5">
      ...
      <h1 className="font-display text-4xl">Profit & loss and GST</h1>
      <p className="mt-2 text-sm text-ink-soft">
        April to March. Agri sales sit in exempt heads. GST here is a working summary, not a GSTR filing.
      </p>
      ...
      <section className="mt-6 rounded-3xl bg-leaf-deep px-5 py-5 text-cream">
        ...
        <p className="mt-2 text-sm text-sand">
          Input GST {formatInr(snap.inputGst)} · Output GST {formatInr(snap.outputGst)} · Net GST{" "}
          {formatInr(snap.outputGst - snap.inputGst)}
        </p>
      </section>

      <p className="mt-6 text-sm">
        <Link href="/admin/books" className="font-semibold text-leaf underline-draw">
